...
class CartaoSelecionadoRepository {
    fun getCartaoSelecionado(): MutableList<Card> {
        return mutableListOf(
            ...
            Card("R$ 400,00", R.drawable.ic_visa, "1213", "Luis Victor", "06/28",
                R.drawable.background_card_red),
